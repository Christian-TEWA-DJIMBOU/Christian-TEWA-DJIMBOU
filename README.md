...
1st year Engineering Cycle student at **EFREI Paris**, currently on academic exchange in **Malaysia** until **MAY 2026**. I build real-world data pipelines and I'm actively preparing for the **AWS Certified Data Engineer – Associate (DEA-C01)** certification.

📍 Cachan, Île-de-France | 🎓 EFREI Paris | 🔍 Seeking 24-month Data Engineering alternance — September 2026
...
| | |
|---|---|
| 🏦 [**Banking Transactions Data Warehouse**](https://github.com/Christian-TEWA-DJIMBOU/banking-transactions-warehouse) | End-to-end DWH for banking analytics — star schema, ETL, data quality — **Python · PostgreSQL · Docker** |
| 🚦 [**ETL Pipeline – Toll Traffic Processing**](https://github.com/Christian-TEWA-DJIMBOU/airflow-docker-toll-data-pipeline) | Automated ETL from 3 file formats (CSV, TSV, fixed-width) with full Airflow orchestration — **Airflow · PostgreSQL · Docker** |

---

## 🚀 What I Do

- 🏗️ Design and build **ETL/ELT pipelines** from multi-source data (APIs, CSV, ERP, web scraping)
- 🗄️ Implement **dimensional modeling** (star schema, data warehousing) with PostgreSQL
- ☁️ Practicing **AWS cloud services** (S3, Glue) — actively preparing **AWS DEA-C01**
- 🐳 Containerize data environments with **Docker** and orchestrate workflows with **Apache Airflow**
- 📊 Analyze and visualize data with **Pandas, NumPy, Matplotlib, Power BI**

> **My conviction:** Real skills come from real projects. A deployed pipeline beats a list of buzzwords on a resume.
...
### ☁️ AWS Certification — DEA-C01
Actively preparing for the **AWS Certified Data Engineer – Associate** exam. Hands-on practice with:
...
**Stagiaire Data Engineering** — ELECT-CAM SARL, Douala, Cameroon *(June – August 2025)*  
Built a Python ETL pipeline collecting, cleaning and processing sales & production data from 3 sources (ERP, CSV, internal databases).

**Stagiaire Développement Web** — Graphic Industrie, Cameroon *(May – July 2024)*  
Designed a student-teacher appointment web application — HTML, CSS, JavaScript, PHP.

---

## 🎓 Education

- 🏫 **EFREI Paris** — Cycle Ingénieur, Data & AI track *(Since Sept. 2025)*
- 📚 **Institut Universitaire de la Côte** — Classe Préparatoire Informatique, Douala *(2023 – 2025)*
...
<p>
  <a href="https://www.linkedin.com/in/christian-tewa-djimbou-9094b1365/" target="_blank">
    <img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white"/>
  </a>
  <a href="mailto:christian.tewa-djimbou@efrei.net">
    <img src="https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white"/>
  </a>
  <a href="https://github.com/Christian-TEWA-DJIMBOU">
